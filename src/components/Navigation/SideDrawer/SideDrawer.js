...
const SideDrawer = (props) => {
  ...
  return (
    <nav className={drawerClasses.join(' ')}>
      <img src={sidedrawer_logo} alt="not loaded images" className='sidedrawer_logo'/>
      ...
      <ul>
        ...
        <li> <FontAwesomeIcon
                  ...
                  className="home-icons mr-3"
                />
          <a href="#experience" onClick={props.click}>EXPERIENCE</a>
        </li>
        <li> <FontAwesomeIcon
                  icon={faBriefcase}
                  className="home-icons mr-3"
                />
          <a href="#work" onClick={props.click}>WORK</a>
        </li>
        <li> <FontAwesomeIcon
                  icon={faIdCard}
                  className="home-icons mr-3"
